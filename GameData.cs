...
public class GameData
{
  ...
  public void FillData(bool newGame)
  {
    ...
    this.gameUniqueId = AtOManager.Instance.GetGameUniqueId();
    ...
    this.singularityMadness = AtOManager.Instance.GetSingularityMadness();
    ...
    this.upgradedCardsInAltarByWho = AtOManager.Instance.upgradedCardsInAltarByWho;
  ...
  public void LoadData(bool comingFromReloadCombat = false)
  {
    ...
    AtOManager.Instance.SetGameUniqueId(this.gameUniqueId);
    ...
    AtOManager.Instance.SetSingularityMadness(this.singularityMadness);
    ...
    AtOManager.Instance.upgradedCardsInAltarByWho = this.upgradedCardsInAltarByWho;
  ...
  {
    get => this.gameUniqueId;
    set => this.gameUniqueId = value;
  }
}
