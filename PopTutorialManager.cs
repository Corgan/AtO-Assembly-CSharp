...
public class PopTutorialManager : MonoBehaviour
{
  ...
  public void Show(string type, Vector3 position, Vector3 position2)
  {
    switch (type)
    {
      ...
      case "townItemCraft":
        this.box.transform.position = new Vector3(0.0f, 0.0f, this.box.transform.position.z);
        string body1 = string.Format(Texts.Instance.GetText("tutorialTownCraft"), (object) Globals.Instance.GetCardData("fireball", false).CardName, (object) "Evelyn");
      ...
      case "townItemUpgrade":
        this.box.transform.position = new Vector3(0.0f, 0.0f, this.box.transform.position.z);
        string body2 = string.Format(Texts.Instance.GetText("tutorialTownUpgrade"), (object) Globals.Instance.GetCardData("faststrike", false).CardName, (object) "Magnus");
      ...
      case "townItemLoot":
        this.box.transform.position = new Vector3(0.0f, 0.0f, this.box.transform.position.z);
        string body3 = string.Format(Texts.Instance.GetText("tutorialTownLoot"), (object) Globals.Instance.GetCardData("spyglass", false).CardName, (object) "Andrin");
