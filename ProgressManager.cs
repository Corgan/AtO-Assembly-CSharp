...
public class ProgressManager : MonoBehaviour
{
  ...
  public void CheckProgress()
  {
    ...
    if (count > this.totalCardsUnlocked)
    {
      ...
      {
        if (Globals.Instance.GetCardData(AtOManager.Instance.unlockedCards[AtOManager.Instance.unlockedCards.Count - 1 - index], false).CardClass == Enums.CardClass.Item)
          ++_items;
      }
