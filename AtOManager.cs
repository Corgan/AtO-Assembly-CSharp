...
public class AtOManager : MonoBehaviour
{
  ...
  private void Start()
  {
    this.invalidTraitsForTougherMonsters = new List<string>();
    this.invalidTraitsForTougherMonsters.Add("fastmonsters");
    this.invalidTraitsForTougherMonsters.Add("vigorousmonsters");
    this.invalidTraitsForTougherMonsters.Add("resistantmonsters");
    this.InvokeRepeating("PlayedCounter", 0.0f, 1f);
  }
  ...
  {
    this.GiveControlToPlayer(_hero, _player, true);
  }
  ...
  public void ClearGame()
  {
    ...
    this.upgradedCardsInAltarByWho = new Dictionary<string, int>();
  ...
  {
    this.photonView.RPC("NET_SaveCauseTresure", RpcTarget.MasterClient);
  }
  ...
  public bool CheckLoadGameUserHaveAllContent() => true;
  ...
  public void DoLoadGame(bool comingFromReloadCombat = false)
  {
    ...
    {
      if (!this.CheckLoadGameUserHaveAllContent())
      {
        this.ClearGame();
      }
      else
      {
        ...
        if (comingFromReloadCombat)
          return;
        this.StartCoroutine(this.SendStartTelemetryCo(true));
      }
    }
    else
  ...
  {
    this.MovePetFromAccesoryItem();
    this.StartCoroutine(this.ShareGameMP(comingFromReloadCombat));
  }

  private void ShareNGPlus()
  {
    this.photonView.RPC("NET_ShareNGPlus", RpcTarget.Others, (object) this.ngPlus, (object) this.madnessCorruptors);
  }
  ...
  {
    this.photonView.RPC("NET_ShareSingularityMadnesss", RpcTarget.Others, (object) this.singularityMadness);
  }

  [PunRPC]
  private void NET_ShareSingularityMadnesss(int _singularityMadness)
  {
    this.SetSingularityMadness(_singularityMadness);
  }

  private void ShareObeliskMadnessAndMaps()
  {
    this.photonView.RPC("NET_ShareObeliskMadness", RpcTarget.Others, (object) this.obeliskMadness, (object) this.obeliskLow, (object) this.obeliskHigh, (object) this.obeliskFinal);
  }
  ...
  public IEnumerator ShareGameMP(bool comingFromReloadCombat = false)
  {
    ...
    string gameUniqueId = atOmanager.gameUniqueId;
    ...
    int singularityMadness = atOmanager.singularityMadness;
    string str1 = "";
    ...
    for (int index1 = 0; index1 < atOmanager.combatStats.GetLength(0); ++index1)
    {
      for (int index2 = 0; index2 < atOmanager.combatStats.GetLength(1); ++index2)
        str8 = str8 + atOmanager.combatStats[index1, index2].ToString() + "_";
      str8 += "/";
    }
    ...
    if (atOmanager.upgradedCardsInAltarByWho != null)
    {
      string[] array3 = new string[atOmanager.upgradedCardsInAltarByWho.Count];
      atOmanager.upgradedCardsInAltarByWho.Keys.CopyTo(array3, 0);
      int[] array4 = new int[atOmanager.upgradedCardsInAltarByWho.Count];
      atOmanager.upgradedCardsInAltarByWho.Values.CopyTo(array4, 0);
      str6 = JsonHelper.ToJson<string>(array3);
      str7 = JsonHelper.ToJson<int>(array4);
    }
    ...
    string str9 = atOmanager.corruptionCommonCompleted.ToString() + "|" + atOmanager.corruptionUncommonCompleted.ToString() + "|" + atOmanager.corruptionRareCompleted.ToString() + "|" + atOmanager.corruptionEpicCompleted.ToString();
    string str10 = "";
    string str11 = "";
    if (atOmanager.craftedCards != null && atOmanager.craftedCards != null)
    {
      for (int index = 0; index < 4; ++index)
      {
        ...
        {
          string[] array5 = new string[atOmanager.craftedCards[index].Count];
          atOmanager.craftedCards[index].Keys.CopyTo(array5, 0);
          int[] array6 = new int[atOmanager.craftedCards[index].Count];
          atOmanager.craftedCards[index].Values.CopyTo(array6, 0);
          str10 = str10 + JsonHelper.ToJson<string>(array5) + "_";
          str11 = str11 + JsonHelper.ToJson<int>(array6) + "_";
        }
      }
    }
    ...
    {
      string[] array7 = new string[atOmanager.townRerollList.Count];
      atOmanager.townRerollList.Keys.CopyTo(array7, 0);
      string[] array8 = new string[atOmanager.townRerollList.Count];
      atOmanager.townRerollList.Values.CopyTo(array8, 0);
      str12 = JsonHelper.ToJson<string>(array7);
      str13 = JsonHelper.ToJson<string>(array8);
    }
    NetworkManager.Instance.ClearAllPlayerManualReady();
    if (!comingFromReloadCombat)
      atOmanager.StartCoroutine(atOmanager.SendStartTelemetryCo(true));
    atOmanager.photonView.RPC("NET_ShareGameMP", RpcTarget.Others, (object) gameId, (object) gameUniqueId, (object) townTier, (object) currentMapNode, (object) ngPlus, (object) madnessCorruptors, (object) obeliskMadness, (object) singularityMadness, (object) str1, (object) str2, (object) json1, (object) str3, (object) json2, (object) str4, (object) str5, (object) str6, (object) str7, (object) json3, (object) json4, (object) str8, (object) combatExpertise, (object) bossesKilled, (object) json5, (object) monstersKilled, (object) corruptionAccepted, (object) corruptionType, (object) corruptionId, (object) corruptionIdCard, (object) corruptionRewardCard, (object) corruptionRewardChar, (object) str10, (object) str11, (object) str9, (object) playedTime, (object) num, (object) weekly, (object) str12, (object) str13, (object) comingFromReloadCombat);
    ...
    if ((bool) (UnityEngine.Object) MatchManager.Instance)
      atOmanager.StartCoroutine(atOmanager.ShareTeam("Combat", true));
    else if (atOmanager.charInTown)
      atOmanager.StartCoroutine(atOmanager.ShareTeam("Town", true));
    else
      atOmanager.StartCoroutine(atOmanager.ShareTeam("Map", true));
  }

  [PunRPC]
  private void NET_ShareGameMP(
    string _gameId,
    string _gameUniqueId,
    int _townTier,
    string _currentMapNode,
    int _ngPlus,
    string _madnessCorruptors,
    int _obeliskMadness,
    int _singularityMadness,
    ...
    string _upgradedKeys,
    string _upgradedValues,
    ...
    bool comingFromReloadCombat)
  {
    ...
    this.SetSingularityMadness(_singularityMadness);
    this.gameId = _gameId;
    this.gameUniqueId = _gameUniqueId;
    ...
    if (_upgradedKeys != "")
    {
      string[] strArray7 = JsonHelper.FromJson<string>(_upgradedKeys);
      int[] numArray = JsonHelper.FromJson<int>(_upgradedValues);
      this.upgradedCardsInAltarByWho = new Dictionary<string, int>();
      for (int index = 0; index < strArray7.Length; ++index)
        this.upgradedCardsInAltarByWho.Add(strArray7[index], numArray[index]);
    }
    ...
    if (_craftedKeys != "")
    {
      string[] strArray8 = _craftedKeys.Split('_', StringSplitOptions.None);
      string[] strArray9 = _craftedValues.Split('_', StringSplitOptions.None);
      this.craftedCards = new List<Dictionary<string, int>>();
      for (int index3 = 0; index3 < 4; ++index3)
      {
        if (strArray8[index3].Length > 0)
        {
          string[] strArray10 = JsonHelper.FromJson<string>(strArray8[index3]);
          if (strArray10.Length != 0)
          {
            int[] numArray = JsonHelper.FromJson<int>(strArray9[index3]);
            Dictionary<string, int> dictionary = new Dictionary<string, int>();
            for (int index4 = 0; index4 < strArray10.Length; ++index4)
              dictionary.Add(strArray10[index4], numArray[index4]);
    ...
    if (_rerollKeys != "")
    {
      string[] strArray11 = JsonHelper.FromJson<string>(_rerollKeys);
      string[] strArray12 = JsonHelper.FromJson<string>(_rerollValues);
      ...
      {
        this.townRerollList.Add(strArray11[index], strArray12[index]);
        if (strArray11[index] == playerNick)
        {
          string[] strArray13 = strArray12[index].Split("_", StringSplitOptions.None);
          if (strArray13.Length != 0)
            this.shopItemReroll = strArray13[strArray13.Length - 1];
        }
      }
    }
  ...
  private void InitGame()
  {
    ...
    else if (GameManager.Instance.IsGameAdventure() && this.ngPlus > 0)
    {
      if (this.ngPlus == 3)
        num1 = num2 = 3200;
  ...
  public void SetGameUniqueId(string _gameUniqueId = "")
  {
    if (_gameUniqueId == "")
    {
      ...
      string str = DateTime.Now.ToString("ddMMyyHHmm");
      stringBuilder.Append(this.gameId);
      stringBuilder.Append("_");
      stringBuilder.Append(str);
      stringBuilder.Append("_");
      stringBuilder.Append(Functions.RandomStringSafe(6f).ToUpper());
      this.gameUniqueId = stringBuilder.ToString();
    }
    else
      this.gameUniqueId = _gameUniqueId;
    if (!GameManager.Instance.IsMultiplayer() || !NetworkManager.Instance.IsMaster())
      return;
    this.photonView.RPC("NET_SetGameUniqueId", RpcTarget.Others, (object) this.gameUniqueId);
  }

  [PunRPC]
  private void NET_SetGameUniqueId(string _gameUniqueId) => this.SetGameUniqueId(_gameUniqueId);

  public void SetWeeklyRandomState()
  {
    UnityEngine.Random.InitState(("WeeklyChallengeWeek" + Functions.GetCurrentWeeklyWeek().ToString()).GetDeterministicHashCode());
  }
  ...
  public string GetGameUniqueId() => this.gameUniqueId;
  ...
  {
    return this.craftedCards == null || index >= this.craftedCards.Count || this.craftedCards[index] == null || !this.craftedCards[index].ContainsKey(cardId) ? 0 : this.craftedCards[index][cardId];
  }
  ...
  {
    this.mpPlayersGold = _mpPlayersGold;
  }
  ...
  {
    this.mpPlayersDust = _mpPlayersDust;
  }
  ...
  {
    this.photonView.RPC("NET_MASTERGivePlayer", RpcTarget.MasterClient, (object) type, (object) quantity, (object) to, (object) from, (object) true, (object) true);
  }

  public void AskForGold(string nick, int quantity)
  {
    this.photonView.RPC("NET_MASTERGivePlayer", RpcTarget.MasterClient, (object) 0, (object) quantity, (object) nick, (object) "", (object) true, (object) true);
  }

  public void AskForDust(string nick, int quantity)
  {
    this.photonView.RPC("NET_MASTERGivePlayer", RpcTarget.MasterClient, (object) 1, (object) quantity, (object) nick, (object) "", (object) true, (object) true);
  }
  ...
  {
    return index >= 0 && index < 5 && this.teamAtO != null && this.teamAtO.Length != 0 ? this.teamAtO[index] : (Hero) null;
  }
  ...
  public bool CharacterHaveItem(string _subclassId, string _id)
  {
    ...
    for (int index = 0; index < this.teamAtO.Length; ++index)
    {
      if (this.teamAtO[index].SubclassName == _subclassId && this.teamAtO[index].HaveItem(_id))
        return true;
    }
    return false;
  }
    ...
    switch (_acId)
    {
      ...
      case "crack":
        ...
        if (_characterCaster != null && _type == "consume")
          num1 = _characterCaster.GetAuraCharges("rust");
      ...
      case "poison":
        ...
        int num3 = 0;
        if (_characterCaster != null && _type == "consume")
          num3 = _characterCaster.GetAuraCharges("rust");
        else if (_characterTarget != null)
      ...
      case "sharp":
        ...
        int num4 = 0;
        if (_characterCaster != null && _type == "consume")
          num4 = _characterCaster.GetAuraCharges("rust");
        else if (_characterTarget != null)
      ...
      case "slow":
        int num5 = 0;
        if (_characterCaster != null && _type == "consume")
          num5 = _characterCaster.GetAuraCharges("rust");
        else if (_characterTarget != null)
      ...
      case "wet":
        ...
        int num6 = 0;
        if (_characterCaster != null && _type == "consume")
          num6 = _characterCaster.GetAuraCharges("rust");
        else if (_characterTarget != null)
  ...
  public bool ValidCardback(CardbackData cbd, int rankProgressN)
  {
    ...
    {
      if (cbd.SingularityLevel == 1 && PlayerManager.Instance.SingularityMadnessLevel > 0)
        flag = true;
  ...
  public void SetCraftReaminingUses(int heroIndex, int uses, bool fromCoop = false)
  {
    if (this.teamAtO == null || this.teamAtO.Length == 0 || heroIndex > this.teamAtO.Length || heroIndex < 0 || this.teamAtO[heroIndex] == null)
      return;
    if ((bool) (UnityEngine.Object) CardCraftManager.Instance && CardCraftManager.Instance.craftType == 0 && GameManager.Instance.IsSingularity() && AtOManager.Instance.CharInTown())
    {
      int num = AtOManager.Instance.HowManyUpgradedCardsInAltar(heroIndex);
      uses -= num;
      if (uses < 0)
        uses = 0;
    }
    ...
    if (!GameManager.Instance.IsMultiplayer() || fromCoop)
      return;
    this.photonView.RPC("NET_SetCraftReaminingUses", RpcTarget.Others, (object) heroIndex, (object) uses);
  }

  [PunRPC]
  private void NET_SetCraftReaminingUses(int heroIndex, int uses)
  {
    this.SetCraftReaminingUses(heroIndex, uses, true);
  }

  public int GetCraftReaminingUses(int heroIndex)
  {
    return heroIndex > -1 && heroIndex < this.teamAtO.Length ? this.teamAtO[heroIndex].CraftRemainingUses : 0;
  }
  ...
  public void SubstractCraftReaminingUses(int heroIndex, int quantity = 1, bool fromCoop = false)
  {
    ...
    if (!GameManager.Instance.IsMultiplayer() || fromCoop)
      return;
    this.photonView.RPC("NET_SubstractCraftReaminingUses", RpcTarget.Others, (object) heroIndex, (object) quantity);
  }

  [PunRPC]
  private void NET_SubstractCraftReaminingUses(int heroIndex, int quantity)
  {
    this.SubstractCraftReaminingUses(heroIndex, quantity, true);
  }
  ...
  public void HeroCraftCrafted(int heroIndex, bool fromCoop = false)
  {
    ...
    if (!GameManager.Instance.IsMultiplayer() || fromCoop)
      return;
    this.photonView.RPC("NET_HeroCraftCrafted", RpcTarget.Others, (object) heroIndex);
  }

  [PunRPC]
  private void NET_HeroCraftCrafted(int heroIndex) => this.HeroCraftCrafted(heroIndex, true);
  ...
  public void HeroCraftUpgraded(int heroIndex, bool fromCoop = false)
  {
    ...
    if (!GameManager.Instance.IsMultiplayer() || fromCoop)
      return;
    this.photonView.RPC("NET_HeroCraftUpgraded", RpcTarget.Others, (object) heroIndex);
  }

  [PunRPC]
  private void NET_HeroCraftUpgraded(int heroIndex) => this.HeroCraftUpgraded(heroIndex, true);
  ...
  public void HeroCraftRemoved(int heroIndex, bool fromCoop = false)
  {
    ...
    if (!GameManager.Instance.IsMultiplayer() || fromCoop)
      return;
    this.photonView.RPC("NET_HeroCraftRemoved", RpcTarget.Others, (object) heroIndex);
  }

  [PunRPC]
  private void NET_HeroCraftRemoved(int heroIndex) => this.HeroCraftRemoved(heroIndex, true);
  ...
  {
    this.photonView.RPC("NET_HeroLevelUpMP", RpcTarget.MasterClient, (object) _heroIndex, (object) _traitId);
  }
  ...
  public void AddCardToHero(int _heroIndex, string _cardName)
  {
    ...
    else
    {
      ...
      {
        CardData dataFromCardData = Functions.GetCardDataFromCardData(cardData, "");
        for (int index = 0; index < this.teamAtO[_heroIndex].Cards.Count; ++index)
        {
          if (Functions.GetCardDataFromCardData(Globals.Instance.GetCardData(this.teamAtO[_heroIndex].Cards[index], false), "").Id == dataFromCardData.Id)
          {
            this.teamAtO[_heroIndex].Cards.RemoveAt(index);
            break;
          }
        }
      }
  ...
  {
    this.photonView.RPC("NET_AddCardToHeroMP", RpcTarget.MasterClient, (object) _heroIndex, (object) _cardName);
  }
    ...
    else
    {
      ...
      else
      {
        ...
        else if (flag1 && _node.nodeData.NodeEvent != null && _node.nodeData.NodeEvent.Length != 0)
        {
          ...
          for (int index = 0; index < _node.nodeData.NodeEvent.Length; ++index)
          {
            if ((UnityEngine.Object) _node.nodeData.NodeEvent[index] != (UnityEngine.Object) null)
            {
              bool flag3 = true;
  ...
  {
    this.SetTownReroll(_nick, _code, false);
  }

  public bool IsTownRerollLimited()
  {
    return !this.sandbox_unlimitedRerolls && !GameManager.Instance.IsObeliskChallenge() && this.GetNgPlus() > 3;
  }

  public bool IsTownRerollAvailable()
  {
    return !this.IsTownRerollLimited() || this.HowManyTownRerolls() <= 0;
  }
  ...
  {
    this.combatThermometerData = _thermometerData;
  }
  ...
  {
    this.playerRequeriments = _playerRequeriments;
  }
  ...
  {
    this.playerRequeriments = ((IEnumerable<string>) _requeriments).ToList<string>();
  }

  public void AddPlayerRequirementOthers(string _requirementId)
  {
    this.photonView.RPC("NET_AddPlayerRequirement", RpcTarget.Others, (object) _requirementId);
  }
  ...
  public void RemovePlayerRequirement(EventRequirementData requirement, string requirementId = "")
  {
    if (requirementId != "")
    {
      ...
      if ((UnityEngine.Object) requirement == (UnityEngine.Object) null)
        return;
    }
    bool flag = false;
    if (!GameManager.Instance.IsObeliskChallenge() && (!GameManager.Instance.IsMultiplayer() || NetworkManager.Instance.IsMaster()))
  ...
  {
    return (UnityEngine.Object) requirement == (UnityEngine.Object) null && requirementId == "" || (UnityEngine.Object) requirement != (UnityEngine.Object) null && this.playerRequeriments.Contains(requirement.RequirementId) || requirementId != "" && this.playerRequeriments.Contains(requirementId);
  }
  ...
  {
    CardData cardData1 = Globals.Instance.GetCardData(itemToAddName, false);
    string _cardId = itemToAddName;
    bool flag = false;
    int num = -1;
    string id = "";
    if ((UnityEngine.Object) cardData1 != (UnityEngine.Object) null)
    {
      if (cardData1.CardType == Enums.CardType.Weapon)
      {
        num = 0;
        id = this.teamAtO[_heroIndex].Weapon;
      }
      else if (cardData1.CardType == Enums.CardType.Armor)
      {
        num = 1;
        id = this.teamAtO[_heroIndex].Armor;
      }
      else if (cardData1.CardType == Enums.CardType.Jewelry)
      {
        num = 2;
        id = this.teamAtO[_heroIndex].Jewelry;
      }
      else if (cardData1.CardType == Enums.CardType.Accesory)
      {
        num = 3;
        id = this.teamAtO[_heroIndex].Accesory;
      }
      else if (cardData1.CardType == Enums.CardType.Pet)
      {
        num = 4;
        id = this.teamAtO[_heroIndex].Pet;
      }
      else if (cardData1.CardType == Enums.CardType.Enchantment)
        this.teamAtO[_heroIndex].AssignEnchantment(itemToAddName);
      else
        this.teamAtO[_heroIndex].Corruption = "";
      if (num > -1 && (!(id != "") || !((UnityEngine.Object) cardData1.UpgradesToRare == (UnityEngine.Object) null) || !(cardData1.Id == id)) && (!(id != "") || !((UnityEngine.Object) cardData1.UpgradesToRare != (UnityEngine.Object) null) || !(cardData1.UpgradesToRare.Id == id)))
      {
        if (cardData1.Id == id)
        {
          if ((UnityEngine.Object) cardData1.UpgradesToRare != (UnityEngine.Object) null)
            itemToAddName = Functions.GetCardDataFromCardData(cardData1, "RARE").Id;
        }
        else if (id != "")
        {
          CardData cardData2 = Globals.Instance.GetCardData(id, false);
          if ((UnityEngine.Object) cardData2 != (UnityEngine.Object) null && cardData2.BaseCard != "" && cardData1.BaseCard != "" && cardData2.BaseCard.ToLower() == cardData1.BaseCard.ToLower() && (UnityEngine.Object) cardData2.UpgradesToRare != (UnityEngine.Object) null)
          {
            CardData dataFromCardData = Functions.GetCardDataFromCardData(cardData2, "RARE");
            if ((UnityEngine.Object) dataFromCardData != (UnityEngine.Object) null)
              itemToAddName = dataFromCardData.Id;
          }
        }
        switch (num)
        {
          case 0:
            ...
            this.teamAtO[_heroIndex].Weapon = itemToAddName;
            break;
          case 1:
            this.RemoveItemFromHero(true, _heroIndex, "armor");
            this.teamAtO[_heroIndex].Armor = itemToAddName;
            break;
          case 2:
            this.RemoveItemFromHero(true, _heroIndex, "jewelry");
            this.teamAtO[_heroIndex].Jewelry = itemToAddName;
            break;
          case 3:
            this.RemoveItemFromHero(true, _heroIndex, "accesory");
            this.teamAtO[_heroIndex].Accesory = itemToAddName;
            break;
          case 4:
            this.RemoveItemFromHero(true, _heroIndex, "pet");
            this.teamAtO[_heroIndex].Pet = itemToAddName;
            break;
        }
        cardData1 = Globals.Instance.GetCardData(itemToAddName, false);
        flag = true;
      }
    ...
    if (flag)
    {
      if ((UnityEngine.Object) cardData1 != (UnityEngine.Object) null && (UnityEngine.Object) cardData1.Item != (UnityEngine.Object) null)
      {
        ItemData itemData = cardData1.Item;
        if (itemData.MaxHealth != 0)
          this.teamAtO[_heroIndex].ModifyMaxHP(itemData.MaxHealth);
        else
          this.SideBarRefresh();
      }
      this.teamAtO[_heroIndex].SetEvent(Enums.EventActivation.CharacterAssign, auxString: itemToAddName);
      this.teamAtO[_heroIndex].ResetItemDataBySlotCache();
      this.teamAtO[_heroIndex].ClearCaches();
    }
  ...
  {
    this.photonView.RPC("AddItemToHero", RpcTarget.All, (object) _heroIndex, (object) _itemName, (object) _itemListId);
  }
  ...
  {
    this.photonView.RPC("RemoveItemFromHero", RpcTarget.All, (object) _isHero, (object) _heroIndex, (object) _slot, (object) _id);
  }
  ...
  public void RemoveItemList(bool keepPets)
  {
    ...
    if (this.boughtItemInShopByWho == null || this.boughtItemInShopByWho.Count <= 0)
      return;
    if (keepPets)
    {
      List<string> stringList = new List<string>();
      foreach (string key in this.boughtItemInShopByWho.Keys)
      {
        if (!key.StartsWith("petShop"))
          stringList.Add(key);
      }
      foreach (string key in stringList)
        this.boughtItemInShopByWho.Remove(key);
    }
    else
      this.boughtItemInShopByWho.Clear();
  }
  ...
  {
    this.SaveBoughtItem(_heroIndex, _shopId, _cardId);
  }
  ...
  {
    if (this.upgradedCardsInAltarByWho == null)
      this.upgradedCardsInAltarByWho = new Dictionary<string, int>();
    string key = string.Format("{0}{1}{2}{3}", (object) heroIndex, (object) this.townZoneId, (object) this.townTier, (object) this.currentMapNode);
    if (!this.upgradedCardsInAltarByWho.ContainsKey(key))
      this.upgradedCardsInAltarByWho.Add(key, 1);
    else
      this.upgradedCardsInAltarByWho[key]++;
    if (!GameManager.Instance.IsMultiplayer() || fromCoop)
      return;
    this.photonView.RPC("NET_SaveUpgradedCardInAltar", RpcTarget.Others, (object) heroIndex);
  }

  [PunRPC]
  private void NET_SaveUpgradedCardInAltar(int heroIndex)
  {
    this.SaveUpgradedCardInAltar(heroIndex, true);
  }
  ...
  public int HowManyUpgradedCardsInAltar(int heroIndex)
  {
    if (this.upgradedCardsInAltarByWho == null)
      return 0;
    string key = string.Format("{0}{1}{2}{3}", (object) heroIndex, (object) this.townZoneId, (object) this.townTier, (object) this.currentMapNode);
    return this.upgradedCardsInAltarByWho.ContainsKey(key) ? this.upgradedCardsInAltarByWho[key] : 0;
  }
  ...
  {
    return this.lootListId != "" && this.lootListId != null ? this.lootListId : "";
  }
  ...
  {
    return !this.IsZoneAffectedByMadness() && !_fromSave ? 0 : this.ngPlus;
  }
  ...
  {
    if (Globals.Instance.ShowDebug)
      Functions.DebugLogGD("*** SET SINGULARITY MADNESS **** " + _value.ToString(), "trace");
    this.singularityMadness = _value;
    if (!GameManager.Instance.IsSingularity())
      return;
    this.SetSingularityMadnessTraits(this.singularityMadness);
  }

  public int GetSingularityMadness() => this.singularityMadness;
  ...
  {
    return MadnessManager.Instance.CalculateMadnessTotal(this.ngPlus, this.madnessCorruptors);
  }
  ...
  {
    this.StartCoroutine(this.DoCraftHealerCo(4, discount, itemListId: shopListId));
  }
  ...
  public void BeginAdventure()
  {
    ...
    this.SetGameUniqueId();
    for (int index = 0; index < 4; ++index)
    {
      if (this.teamAtO[index] != null && (UnityEngine.Object) this.teamAtO[index].HeroData != (UnityEngine.Object) null && (UnityEngine.Object) this.teamAtO[index].HeroData.HeroSubClass != (UnityEngine.Object) null && (UnityEngine.Object) this.teamAtO[index].HeroData.HeroSubClass.Trait0 != (UnityEngine.Object) null)
    ...
    else if (!GameManager.Instance.IsMultiplayer() && this.IsFirstGame() && GameManager.Instance.IsGameAdventure())
    ...
    {
      if (GameManager.Instance.IsObeliskChallenge())
        this.StartCoroutine(this.ShareTeam("ChallengeSelection", true));
      else
        this.StartCoroutine(this.ShareTeam("IntroNewGame", true));
    }
    else if (!GameManager.Instance.IsMultiplayer())
    {
      if (GameManager.Instance.IsObeliskChallenge())
    ...
    this.StartCoroutine(this.SendStartTelemetryCo(false));
    if (!GameManager.Instance.IsMultiplayer())
      return;
    this.photonView.RPC("NET_SendStartTelemetryCo", RpcTarget.Others);
  }

  [PunRPC]
  private void NET_SendStartTelemetryCo() => this.StartCoroutine(this.SendStartTelemetryCo(false));
  ...
  public void SetObeliskMadnessTraits(int _madnessLevel)
  {
    ...
    foreach (KeyValuePair<string, ChallengeTrait> keyValuePair in Globals.Instance.ChallengeTraitsSource)
    {
      if (keyValuePair.Value.IsMadnessTrait && keyValuePair.Value.Order <= _madnessLevel)
        this.ChallengeTraits.Add(keyValuePair.Value.Id.ToLower());
    }
    if (_madnessLevel >= 0)
      this.ChallengeTraits.Add("energizedheroeslow");
    if (_madnessLevel < 8)
  ...
  public void SetSingularityMadnessTraits(int _madnessLevel)
  {
    ...
    foreach (KeyValuePair<string, ChallengeTrait> keyValuePair in Globals.Instance.ChallengeTraitsSource)
    {
      if (keyValuePair.Value.IsSingularityTrait && keyValuePair.Value.OrderSingularity <= _madnessLevel)
        this.ChallengeTraits.Add(keyValuePair.Value.Id.ToLower());
    }
  }
  ...
  {
    return (GameManager.Instance.IsObeliskChallenge() || GameManager.Instance.IsSingularity()) && this.ChallengeTraits != null && this.ChallengeTraits.Contains(_trait.ToLower()) && (!this.ChallengeTraits.Contains("toughermonsters") || !this.invalidTraitsForTougherMonsters.Contains(_trait.ToLower()));
  }
