...
public class LootManager : MonoBehaviour
{
  ...
  {
    this.StartCoroutine(this.ActivateCharacterCo(charToActivate));
  }
  ...
  public void Looted(string lootId)
  {
    ...
    string itemToAddName = lootId.Split('_', StringSplitOptions.None)[0];
    this.StartCoroutine(this.LootTrail(this.activeCharacter, lootId, transform));
    AtOManager.Instance.AddItemToHero(this.characterOrder[this.activeCharacter], itemToAddName);
