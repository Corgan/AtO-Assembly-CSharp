...
public class CharacterGOItem : MonoBehaviour
{
  ...
  private void Start()
  {
    ...
    if (!((Object) component != (Object) null) || !((Object) this.transform.parent != (Object) null) || !((Object) this.transform.parent.parent != (Object) null) || !(this.transform.parent.parent.name == "NPCs"))
      return;
