...
public class Character
{
  ...
  {
    this.traitClass.DoTrait(Enums.EventActivation.None, funcName, this, (Character) null, 0, "", (CardData) null);
  }
  ...
  public bool HaveTrait(string traitId)
  {
    if (this.traits != null && this.traits.Length != 0)
    {
      ...
      for (int index = 0; index < this.traits.Length; ++index)
      {
        if (this.traits[index] != null && this.traits[index] == traitId)
          return true;
      }
    }
    return false;
  ...
  {
    return this.experience >= Globals.Instance.GetExperienceByLevel(this.level);
  }
  ...
  {
    if (Globals.Instance.ShowDebug)
      Functions.DebugLogGD("SetAura " + this.Id + " | " + _acData.Id + "(" + charges.ToString() + ")", "trace");
    ...
    if (_acData.Id.ToLower() == "spellsword" && this.isHero && this.GetAuraCharges("spellsword") == 4 && charges > 0)
    {
      if (AtOManager.Instance.CharacterHaveTrait(this.subclassName, "frostswords"))
        MatchManager.Instance.GenerateNewCard(1, "frostdischarge", true, Enums.CardPlace.Hand);
      if (AtOManager.Instance.CharacterHaveTrait(this.subclassName, "timeloop") || AtOManager.Instance.CharacterHaveTrait(this.subclassName, "timeparadox"))
      {
        int num = 1;
        if (AtOManager.Instance.CharacterHaveTrait(this.subclassName, "timeloop") && AtOManager.Instance.CharacterHaveTrait(this.subclassName, "timeparadox"))
          num = 2;
        if (!MatchManager.Instance.ItemExecuteForThisCombat(this.subclassName, "timeloop", num, ""))
        {
          this.SetAuraTrait(this, "inspire", 1);
          MatchManager.Instance.MoveCards(Enums.CardPlace.Vanish, Enums.CardPlace.RandomDeck, Enums.CardClass.Mage, 3);
          this.heroItem.ScrollCombatText(Texts.Instance.GetText("traits_Time Loop") + Functions.TextChargesLeft(MatchManager.Instance.ItemExecutedInThisCombat(this.subclassName, "timeloop"), num), Enums.CombatScrollEffectType.Trait);
        }
    ...
    if ((UnityEngine.Object) auraCurseData.RemoveAuraCurse != (UnityEngine.Object) null || (UnityEngine.Object) auraCurseData.RemoveAuraCurse2 != (UnityEngine.Object) null)
    {
      for (int index = this.auraList.Count - 1; index >= 0; --index)
      {
        if (this.auraList[index] != null && (UnityEngine.Object) this.auraList[index].ACData != (UnityEngine.Object) null && ((UnityEngine.Object) auraCurseData.RemoveAuraCurse != (UnityEngine.Object) null && this.auraList[index].ACData.Id == auraCurseData.RemoveAuraCurse.Id || (UnityEngine.Object) auraCurseData.RemoveAuraCurse2 != (UnityEngine.Object) null && this.auraList[index].ACData.Id == auraCurseData.RemoveAuraCurse2.Id))
        {
          StringBuilder stringBuilder = new StringBuilder();
          stringBuilder.Append("<s>");
          stringBuilder.Append(Functions.UppercaseFirst(this.auraList[index].ACData.ACName));
          stringBuilder.Append("</s>");
          string text = stringBuilder.ToString();
    ...
    if (Globals.Instance.ShowDebug)
      Functions.DebugLogGD("added aura " + auraCurseData.Id + " charges " + num5.ToString(), "trace");
  ...
  {
    return (UnityEngine.Object) cardData != (UnityEngine.Object) null ? cardData.GetCardFinalCost() : 0;
  }
  ...
  {
    return !((UnityEngine.Object) cardData.SummonUnit != (UnityEngine.Object) null) || cardData.Evolve || cardData.Metamorph || MatchManager.Instance.GetNPCAvailablePosition() != -1;
  }
  ...
  public int GetAuraStatModifiers(int source, Enums.CharacterStat stat)
  {
    ...
    for (int index = 0; index < this.auraList.Count; ++index)
    {
      if (this.auraList[index] != null)
      {
        ...
        {
          AuraCurseData auraCurseData = AtOManager.Instance.GlobalAuraCurseModificationByTraitsAndItems("set", acData.Id, this, this);
          if (auraCurseData.CharacterStatAbsolute)
          {
            if (auraCurseData.Id == "shackle" && stat == Enums.CharacterStat.Speed)
            {
              flag = true;
            }
            else
            {
              auraStatModifiers = auraCurseData.CharacterStatAbsoluteValue + auraCurseData.CharacterStatAbsoluteValuePerStack * this.auraList[index].AuraCharges;
              break;
            }
          }
          else
          {
            int num1 = auraStatModifiers + auraCurseData.CharacterStatModifiedValue;
            float num2 = 1f / (float) auraCurseData.CharacterStatChargesMultiplierNeededForOne;
            int num3 = auraCurseData.CharacterStatModifiedValuePerStack >= 0 ? Mathf.FloorToInt(num2 * (float) this.auraList[index].AuraCharges * (float) auraCurseData.CharacterStatModifiedValuePerStack) : -1 * Mathf.FloorToInt(Mathf.Abs(num2 * (float) this.auraList[index].AuraCharges * (float) auraCurseData.CharacterStatModifiedValuePerStack));
    ...
    CardData cardAux = null)
  {
    if ((bool) (UnityEngine.Object) MatchManager.Instance && this.useCache)
    {
      string id = (UnityEngine.Object) cardAux == (UnityEngine.Object) null ? "" : cardAux.Id;
      StringBuilder stringBuilder = new StringBuilder();
      stringBuilder.Append(this.GetAuraListString());
      stringBuilder.Append("-");
    ...
    {
      AuraCurseData acData = this.auraList[index].ACData;
      if ((UnityEngine.Object) acData != (UnityEngine.Object) null && (!((UnityEngine.Object) cardAux != (UnityEngine.Object) null) || !cardAux.IsGoingToPurgeThisAC(acData.Id)))
      {
        if (acData.Id == acId)
          flag = true;
        int auraCharges = this.auraList[index].AuraCharges;
    ...
    CardData cardAux = null)
  {
    ...
    if (num < 1000)
    {
      ...
      num = num + this.GetItemResistModifiers(damageType) + this.GetAuraResistModifiers(damageType, acId, countChargesConsumedPre, countChargesConsumedPost, cardAux);
    }
  ...
  public int IncreasedCursedDamagePerStack(Enums.DamageType damageType, CardData cardAux = null)
  {
    ...
    for (int index = 0; index < this.auraList.Count; ++index)
    {
      if (this.auraList[index] != null)
      {
        ...
        if ((UnityEngine.Object) aura.ACData != (UnityEngine.Object) null && (!((UnityEngine.Object) cardAux != (UnityEngine.Object) null) || !cardAux.IsGoingToPurgeThisAC(aura.ACData.Id)))
        {
          if (aura.ACData.IncreasedDamageReceivedType == damageType || aura.ACData.IncreasedDamageReceivedType == Enums.DamageType.All)
          {
            ...
            int num3 = (double) aura.ACData.IncreasedDirectDamageReceivedPerStack >= 0.0 ? Mathf.FloorToInt(num2 * (float) aura.AuraCharges * aura.ACData.IncreasedDirectDamageReceivedPerStack) : -1 * Mathf.FloorToInt(Mathf.Abs(num2 * (float) aura.AuraCharges * aura.ACData.IncreasedDirectDamageReceivedPerStack));
            num1 += num3;
          }
          if (aura.ACData.IncreasedDamageReceivedType2 == damageType)
          {
            ...
            int num5 = (double) aura.ACData.IncreasedDirectDamageReceivedPerStack2 >= 0.0 ? Mathf.FloorToInt(num4 * (float) aura.AuraCharges * aura.ACData.IncreasedDirectDamageReceivedPerStack2) : -1 * Mathf.FloorToInt(Mathf.Abs(num4 * (float) aura.AuraCharges * aura.ACData.IncreasedDirectDamageReceivedPerStack2));
            num1 += num5;
          }
        }
      }
  ...
  public Dictionary<string, int> GetAuraDamageTakenDictionary(Enums.DamageType damageType)
  {
    ...
    for (int index = 0; index < this.auraList.Count; ++index)
    {
      ...
      if (aura.ACData.IncreasedDamageReceivedType2 == damageType)
      {
        int num4 = Functions.FuncRoundToInt((float) (1.0 / (double) aura.ACData.IncreasedDirectDamageChargesMultiplierNeededForOne2 * (double) aura.AuraCharges) * aura.ACData.IncreasedDirectDamageReceivedPerStack2);
        num1 += num4;
      }
      if (num1 != 0)
  ...
  public int DamageWithCharacterBonus(
    ...
    Enums.CardClass CC,
    int energyCost = 0,
    int additionalDamage = -1000)
  {
    if (this.isHero && (CC == Enums.CardClass.Monster || CC == Enums.CardClass.Injury || CC == Enums.CardClass.Boon))
      return value;
    int num1 = value;
    if (additionalDamage != -1000)
      num1 += additionalDamage;
    int num2 = 0;
    int num3 = num1 + num2;
    float[] numArray = this.DamageBonus(DT, energyCost);
    float num4 = (float) (num3 + this.GetTraitDamageFlatModifiers(DT) + this.GetItemDamageFlatModifiers(DT)) + numArray[0];
    if ((UnityEngine.Object) this.heroData != (UnityEngine.Object) null)
      num4 += (float) PlayerManager.Instance.GetPerkDamageBonus(this.heroData.HeroSubClass.Id, DT);
    int ngPlus = AtOManager.Instance.GetNgPlus();
    if (!this.isHero)
    {
      switch (ngPlus)
    ...
    float num5 = numArray[1] + this.GetTraitDamagePercentModifiers(DT) + this.GetItemDamagePercentModifiers(DT);
    int num6 = Functions.FuncRoundToInt(num4 + (float) ((double) num4 * (double) num5 * 0.0099999997764825821));
    if (!this.isHero && AtOManager.Instance.Sandbox_additionalMonsterDamage != 0)
      num6 += Functions.FuncRoundToInt((float) (num6 * AtOManager.Instance.Sandbox_additionalMonsterDamage) * 0.01f);
    return num6;
  }
  ...
  public float[] HealReceivedBonus(bool isIndirect = false, CardData cardAux = null)
  {
    ...
    for (int index = 0; index < this.auraList.Count; ++index)
    {
      ...
      {
        AuraCurseData acData = this.auraList[index].ACData;
        if (!((UnityEngine.Object) cardAux != (UnityEngine.Object) null) || !cardAux.IsGoingToPurgeThisAC(acData.Id))
        {
          int auraCharges = this.auraList[index].AuraCharges;
  ...
  {
    int num1 = heal;
    float[] numArray = this.HealReceivedBonus(isIndirect, cardAux);
  ...
  {
    if (!(this.subclassName == "queen") || !((UnityEngine.Object) this.heroItem != (UnityEngine.Object) null))
      return;
    int auraCharges = this.GetAuraCharges("spellsword");
    if (auraCharges == this.spellswordTMP)
      return;
    this.spellswordTMP = auraCharges;
    this.heroItem.CleanSwordSprites();
    if (auraCharges < 1)
      return;
    this.heroItem.ShowHideSwordSprite(0, true);
    if (auraCharges < 2)
      return;
    this.heroItem.ShowHideSwordSprite(4, true);
    if (auraCharges < 3)
      return;
    this.heroItem.ShowHideSwordSprite(2, true);
    if (auraCharges < 4)
      return;
    this.heroItem.ShowHideSwordSprite(1, true);
    if (auraCharges < 5)
      return;
    this.heroItem.ShowHideSwordSprite(3, true);
  }
