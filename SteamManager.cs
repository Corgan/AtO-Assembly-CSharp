...
public class SteamManager : MonoBehaviour
{
  ...
  private bool LauncherEnabledDLC(uint _appId)
  {
    ...
    {
      case 2168960:
        str = "spooky_nights_in_senenthia";
        break;
      case 2325780:
        str = "wolf_wars";
        break;
      case 2511580:
        str = "sands_of_ulminin";
        break;
      case 2666340:
        str = "amelia_the_queen";
        break;
      case 2879680:
        str = "nenukil_the_engineer";
        break;
      case 2879690:
        str = "the_obsidian_uprising";
        break;
    }
    return !GameManager.Instance.DisabledDLCs.Contains(str);
  }
  ...
  {
    return this.dlcInfo != null && this.dlcInfo.ContainsKey(_sku) ? this.dlcInfo[_sku] : "";
  }
  ...
  public async void SetSingularityScore(int score, bool singleplayer = true)
  {
    if (score <= 0)
      return;
    await this.SetSingularityScoreLeaderboard(score, singleplayer);
  }
  ...
  public async Task SetSingularityScoreLeaderboard(int score, bool singleplayer = true)
  {
    ...
    if (singleplayer)
    {
      Leaderboard? leaderboardAsync = await SteamUserStats.FindLeaderboardAsync("Singularity");
      if (leaderboardAsync.HasValue)
      {
        LeaderboardUpdate? nullable = await leaderboardAsync.Value.SubmitScoreAsync(score, new int[2]
        {
    ...
    {
      Leaderboard? leaderboardAsync = await SteamUserStats.FindLeaderboardAsync("SingularityCoop");
      if (leaderboardAsync.HasValue)
      {
        LeaderboardUpdate? nullable = await leaderboardAsync.Value.SubmitScoreAsync(score, new int[2]
        {
