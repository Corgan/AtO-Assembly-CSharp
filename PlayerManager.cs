...
public class PlayerManager : MonoBehaviour
{
  ...
  public void InitPlayerData()
  {
    ...
    this.singularityMadnessLevel = 0;
  }
  ...
  public void ModifyProgress(string _subclassId, int _quantity, int _index = -1)
  {
    ...
    if ((UnityEngine.Object) subClassData1 == (UnityEngine.Object) null)
      return;
    if (!subClassData1.MainCharacter && _index > -1)
    {
      flag = false;
      ...
      if (teamBackup != null && teamBackup.Length > _index && teamBackup[_index] != null)
      {
        ...
        if ((UnityEngine.Object) subClassData2 != (UnityEngine.Object) null && subClassData2.MainCharacter)
        {
  ...
  {
    return this.unlockedNodes != null && this.unlockedNodes.Contains(nodeName);
  }
  ...
  public void HeroUnlock(string subclass, bool save = true, bool achievement = true)
  {
    ...
    if (!this.unlockedHeroes.Contains(subclass))
    {
      ...
      if ((UnityEngine.Object) subClassData != (UnityEngine.Object) null && !subClassData.InitialUnlock)
  ...
  {
    return this.unlockedHeroes != null && this.unlockedHeroes.Contains(subclass);
  }
  ...
  public void CardUnlock(string cardId, bool save = false, CardItem cardItem = null)
  {
    ...
    CardData cardData1 = Globals.Instance.GetCardData(str, false);
    if ((UnityEngine.Object) cardData1 != (UnityEngine.Object) null && cardData1.CardType == Enums.CardType.Pet)
      Telemetry.SendUnlock("pet", str);
    if (!AtOManager.Instance.unlockedCards.Contains(str))
      AtOManager.Instance.unlockedCards.Add(str);
    ...
    if (!this.unlockedCardsByGame[key].Contains(str))
      this.unlockedCardsByGame[key].Add(str);
    if (save)
      SaveManager.SavePlayerData();
  ...
  {
    return GameManager.Instance.IsGameAdventure() && this.supplyBought != null && this.supplyBought.Contains(supplyId);
  }
  ...
  {
    return this.treasuresClaimed != null && this.treasuresClaimed.Contains(treasureId);
  }
  ...
  public void IncreaseSingularityMadness()
  {
    ...
    if (Globals.Instance.ShowDebug)
      Functions.DebugLogGD("current SingularityLevel " + singularityMadness.ToString(), "trace");
    int num = singularityMadness + 1;
    if (num > 10)
      num = 10;
    if (num > this.singularityMadnessLevel)
      this.singularityMadnessLevel = num;
    if (Globals.Instance.ShowDebug)
      Functions.DebugLogGD("final Singularity " + this.singularityMadnessLevel.ToString(), "trace");
    SaveManager.SavePlayerData();
  }
