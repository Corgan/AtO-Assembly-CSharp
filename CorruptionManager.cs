...
public class CorruptionManager : MonoBehaviour
{
  ...
  private IEnumerator DrawCorruptionCo()
  {
    ...
    corruptionManager.cardCorruption.transform.localPosition = new Vector3(-3.35f, 0.04f, -2f);
    ...
    corruptionManager.cardReward.transform.localPosition = new Vector3(6.65f, -1.35f, -2f);
