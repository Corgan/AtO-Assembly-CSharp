...
public class Globals : MonoBehaviour
{
  ...
  private void Awake()
  {
    ...
    this._IncompatibleVersion.Add("1.3.0", "1.2.5");
    ...
    this._SkuAvailable.Add("2666340");
    this._SkuAvailable.Add("2879690");
    this._SkuAvailable.Add("2879680");
  ...
  public void CreateGameContent()
  {
    ...
    for (int index3 = 0; index3 < nodeDataArray.Length; ++index3)
    {
      ...
      this._NodeDataSource[lower].SourceNodeName = this._NodeDataSource[lower].NodeName;
  ...
  {
    return this._ExperienceByLevel.ContainsKey(level) ? this._ExperienceByLevel[level] : 10000;
  }

  public int GetExperienceByCardCost(int cardCost)
  {
    return this._ExperienceByCardCost.ContainsKey(cardCost) ? this._ExperienceByCardCost[cardCost] : 0;
  }
  ...
  public void CreateCardClones()
  {
    ...
    foreach (string key1 in this._CardsSource.Keys)
    {
      ...
      if (text2 != "")
        card.Fluff = text2;
      if ((card.CardClass != Enums.CardClass.Item || !((UnityEngine.Object) card.Item != (UnityEngine.Object) null) || !card.Item.QuestItem) && card.ShowInTome)
      {
  ...
  {
    return this._ItemDataSource.ContainsKey(id) ? this._ItemDataSource[id] : (ItemData) null;
  }
  ...
  {
    return index > -1 && index < this._AurasCursesIndex.Count ? this._AurasCursesIndex[index] : "";
  }
  ...
  public int GetCraftCost(string cardId, float discountCraft = 0.0f, float discountUpgrade = 0.0f, int zoneTier = 0)
  {
    ...
    else
    {
      ...
      if (this._CraftCost.ContainsKey(stringBuilder.ToString()))
      {
        ...
        if (GameManager.Instance.IsSingularity() && zoneTier == 0 && AtOManager.Instance.CharInTown())
          ...
          num2 += Functions.FuncRoundToInt((float) ((double) num2 * (double) AtOManager.Instance.Sandbox_cardCraftPrice * 0.0099999997764825821));
  ...
  {
    return this._DivinationTier.ContainsKey(divinationIndex) ? this._DivinationTier[divinationIndex] : 0;
  }
  ...
  {
    return Resources.Load("Effects/" + _effect) as GameObject;
  }
  ...
  public Dictionary<string, string> IsoToEnglishCountryNames => this._IsoToEnglishCountryNames;
  ...
  {
    get => this.configPlatform;
    set => this.configPlatform = value;
  }
}
