  ...
  public string NewPerkDescription(PerkData perkData)
  {
    ...
    if ((UnityEngine.Object) perkData != (UnityEngine.Object) null)
    {
      if (perkData.CustomDescription != null && perkData.CustomDescription.Trim() != "")
        ...
        stringBuilder.Append(string.Format(Texts.Instance.GetText("itemHealDone").Replace("<c>", "").OnlyFirstCharToUpper(), (object) perkData.IconTextValue));
      else if (perkData.EnergyBegin > 0)
        stringBuilder.Append(string.Format(Texts.Instance.GetText("itemInitialEnergy").OnlyFirstCharToUpper(), (object) perkData.IconTextValue));
      else if ((UnityEngine.Object) perkData.AuracurseBonus != (UnityEngine.Object) null)
        stringBuilder.Append(string.Format(Texts.Instance.GetText("perkAuraDescription").OnlyFirstCharToUpper(), (object) perkData.IconTextValue));
      else if (perkData.ResistModified == Enums.DamageType.All)
        stringBuilder.Append(string.Format(Texts.Instance.GetText("itemAllResistances").OnlyFirstCharToUpper(), (object) perkData.IconTextValue));
      else if (perkData.DamageFlatBonus == Enums.DamageType.All)
        stringBuilder.Append(string.Format(Texts.Instance.GetText("itemAllDamages").OnlyFirstCharToUpper(), (object) perkData.IconTextValue));
      else if (perkData.DamageFlatBonus == Enums.DamageType.All)
        stringBuilder.Append(string.Format(Texts.Instance.GetText("itemAllDamages").OnlyFirstCharToUpper(), (object) perkData.IconTextValue));
      else if (perkData.DamageFlatBonus != Enums.DamageType.None && perkData.DamageFlatBonus != Enums.DamageType.All)
        stringBuilder.Append(string.Format(Texts.Instance.GetText("itemSingleDamage").OnlyFirstCharToUpper(), (object) Texts.Instance.GetText(Enum.GetName(typeof (Enums.DamageType), (object) perkData.DamageFlatBonus)), (object) perkData.IconTextValue));
      if (stringBuilder.Length > 0)
      {
        ...
        stringBuilder.Append("  <nobr><color=#A0A0A0>[");
        stringBuilder.Append(string.Format(Texts.Instance.GetText("cardsCost"), (object) ("<space=-3>: " + this.nodeCost.ToString())));
        stringBuilder.Append("]</color></nobr>");
        if (this.nodeLocked)
        {
