...
public class EventReplyData
{
  ...
  {
    get => this.repeatForAllWarriors;
    set => this.repeatForAllWarriors = value;
  }

  public bool RepeatForAllScouts
  {
    get => this.repeatForAllScouts;
    set => this.repeatForAllScouts = value;
  }

  public bool RepeatForAllMages
  {
    get => this.repeatForAllMages;
    set => this.repeatForAllMages = value;
  }

  public bool RepeatForAllHealers
  {
    get => this.repeatForAllHealers;
    set => this.repeatForAllHealers = value;
  }
}
