...
public class SubClassData : ScriptableObject
{
  ...
  public bool IsMultiClass() => this.heroClassSecondary != Enums.HeroClass.None;
  ...
  {
    if (!GameManager.Instance.ConfigUseLegacySounds && this.hitSoundRework != null && this.hitSoundRework.Count > 0)
    {
      int index = _soundIndex % this.hitSoundRework.Count;
      if (index < this.hitSoundRework.Count && (UnityEngine.Object) this.hitSoundRework[index] != (UnityEngine.Object) null)
        return this.hitSoundRework[index];
    }
  ...
  {
    get => this.cardsSingularity;
    set => this.cardsSingularity = value;
  }
  ...
  {
    get => this.initialUnlock;
    set => this.initialUnlock = value;
  }

  public string SourceCharacterName
  {
    get => this.sourceCharacterName;
    set => this.sourceCharacterName = value;
  }
}
