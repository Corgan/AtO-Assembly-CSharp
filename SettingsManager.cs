...
public class SettingsManager : MonoBehaviour
{
  ...
  public void Resize() => this.canvas.GetComponent<CanvasScaler>().matchWidthOrHeight = 1f;
  ...
  public void LoadPrefs()
  {
    ...
    this.legacySoundsToggle.isOn = GameManager.Instance.ConfigUseLegacySounds;
    ...
    this.legacySoundsSheepOwlToggle.isOn = GameManager.Instance.ConfigUseLegacySoundsSheepOwl;
