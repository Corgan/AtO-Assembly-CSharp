...
public class TomeManager : MonoBehaviour
{
  ...
  {
    return !((UnityEngine.Object) this.content == (UnityEngine.Object) null) && !((UnityEngine.Object) this.content.gameObject == (UnityEngine.Object) null) && this.content.gameObject.activeSelf;
  }
  ...
  private void ActivateSection(string theSection)
  {
    ...
    if (this.SetTomeCardsCo != null)
      this.StopCoroutine(this.SetTomeCardsCo);
    ...
    foreach (KeyValuePair<string, KeyNotesData> keyNote in Globals.Instance.KeyNotes)
    {
      if (!(keyNote.Value.Id == "daze") && !(keyNote.Value.Id == "haste") && !(keyNote.Value.Id == "frail") && !(keyNote.Value.Id == "reloading"))
      {
        ...
        if (!this.glossaryTermsTitle.ContainsKey(keyNote.Value.KeynoteName))
        {
          ...
          stringBuilder1.Append("<line-height=30%><br></line-height><br><size=-.3><color=#794D31>");
  ...
  public void SetGlossaryPageFromButton(int _buttonIndex)
  {
    ...
    this.SetPage(Mathf.CeilToInt((float) (_buttonIndex + 1) / (float) this.glossaryItemsPerSection), true);
  ...
  private void ClearGlossaryTerm()
  {
    ...
    for (int index = 0; index < this.glossaryItemsPerSection; ++index)
  ...
  {
    this.pageMax = Mathf.CeilToInt((float) this.glossaryTerms.Count / (float) this.glossaryItemsPerSection);
    ...
    else
    {
      ...
      int num1 = 0;
      int index1 = 0;
      int num2 = (this.pageAct - 1) * this.glossaryItemsPerSection;
      int num3 = this.pageAct * this.glossaryItemsPerSection;
      if (num2 < 0)
      {
        num2 = 0;
        num3 = this.glossaryItemsPerSection;
      }
      foreach (KeyValuePair<string, string> glossaryTerm in this.glossaryTerms)
      {
        if (this.glossaryTerms.Count > num1 && num1 >= num2 && num1 < num3)
        {
          ...
          if (Globals.Instance.CurrentLang != "en" && Globals.Instance.CurrentLang != "es")
            this.glossaryTexts[index1].text = this.glossaryTexts[index1].text.Replace("<line-height=30%><br></line-height>", "");
      ...
      for (int index2 = index1; index2 < this.glossaryItemsPerSection; ++index2)
  ...
  {
    this.runDetails.GetComponent<TomeRunDetails>().DoCharacter(_index);
  }
  ...
  {
    this.runDetails.GetComponent<TomeRunDetails>().RunDetailButton(_index);
  }
  ...
  public async void ShowScoreboard(int _index, int _subindex = -1)
  {
    ...
    switch (_index)
    {
      ...
      case 6:
        ...
        this.scoreTitle.text = this.scoreTitleSub.text = Texts.Instance.GetText("singularitySingleplayer");
        break;
      case 7:
        await SteamManager.Instance.GetLeaderboards(7);
        this.scoreTitle.text = this.scoreTitleSub.text = Texts.Instance.GetText("singularityMultiplayer");
        break;
    }
    this.buttonPrevWeekly.transform.gameObject.SetActive(false);
    this.buttonNextWeekly.transform.gameObject.SetActive(false);
  ...
  private void ChangePage()
  {
    ...
    else if (this.scoreboardSection.gameObject.activeSelf)
    {
      if (this.SetScoresCo != null)
        this.StopCoroutine(this.SetScoresCo);
  ...
  public void ShowTomeCardsButtons()
  {
    if (GameManager.Instance.GetDeveloperMode())
      this.TomeButtons[5].transform.gameObject.SetActive(true);
    else
      this.TomeButtons[5].transform.gameObject.SetActive(false);
  ...
  {
    if (this.TomeCardsMasterCo != null)
      this.StopCoroutine(this.TomeCardsMasterCo);
    this.TomeCardsMasterCo = this.StartCoroutine(this.SelectTomeCardsCo(index, absolute));
  }
      ...
      for (int i = indexAct; i < indexAct + this.numCards && pageFor == this.pageAct; ++i)
      {
        ...
        if (i < this.cardList.Count)
        {
          ...
          else
          {
            ...
            if (!gameObject1.gameObject.activeSelf)
          ...
          component1.SetLocalScale(Vector3.one);
          ...
          if (num == 0 || this.searchTerm != "")
          {
            ...
            if ((UnityEngine.Object) this.cardGOBlue[indexTomeCard] != (UnityEngine.Object) null && this.cardGOBlue[indexTomeCard].gameObject.activeSelf)
              this.cardGOBlue[indexTomeCard].gameObject.SetActive(false);
            if ((UnityEngine.Object) this.cardGOGold[indexTomeCard] != (UnityEngine.Object) null && this.cardGOGold[indexTomeCard].gameObject.activeSelf)
              this.cardGOGold[indexTomeCard].gameObject.SetActive(false);
            if ((UnityEngine.Object) this.cardGORare[indexTomeCard] != (UnityEngine.Object) null && this.cardGORare[indexTomeCard].gameObject.activeSelf)
  ...
  {
    if (this.searchBox.gameObject.activeSelf == state)
      return;
    this.searchBox.gameObject.SetActive(state);
  }
