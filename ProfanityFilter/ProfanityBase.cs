...
// Type: ProfanityFilter.ProfanityBase
...
namespace ProfanityFilter
{
  public class ProfanityBase
  {
    ...
    {
      this._profanities = new List<string>((IEnumerable<string>) this._wordList);
    }

    protected ProfanityBase(string[] profanityList)
    {
      this._profanities = profanityList != null ? new List<string>((IEnumerable<string>) profanityList) : throw new ArgumentNullException(nameof (profanityList));
    }

    protected ProfanityBase(List<string> profanityList)
    {
      this._profanities = profanityList != null ? profanityList : throw new ArgumentNullException(nameof (profanityList));
    }
    ...
    public void AddProfanity(string profanity)
    {
      ...
      this._profanities.Add(profanity);
    }
    ...
    public void AddProfanity(string[] profanityList)
    {
      ...
      this._profanities.AddRange((IEnumerable<string>) profanityList);
    }
    ...
    public bool RemoveProfanity(string profanity)
    {
      if (string.IsNullOrEmpty(profanity))
        throw new ArgumentNullException(nameof (profanity));
      return this._profanities.Remove(profanity.ToLower(CultureInfo.InvariantCulture));
    }
    ...
    public void Clear() => this._profanities.Clear();

    public int Count => this._profanities.Count;
  }
}
