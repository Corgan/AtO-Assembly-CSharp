...
namespace ProfanityFilter
{
  public class ProfanityFilter : ProfanityBase, IProfanityFilter
  {
    ...
    {
      return !string.IsNullOrEmpty(word) && !this.AllowList.Contains(word.ToLower(CultureInfo.InvariantCulture)) && this._profanities.Contains(word.ToLower(CultureInfo.InvariantCulture));
    }

    public ReadOnlyCollection<string> DetectAllProfanities(string sentence)
    {
      return this.DetectAllProfanities(sentence, false);
    }
    ...
    {
      return this.CensorString(sentence, censorCharacter, false);
    }
    ...
    {
      swearList.AddRange(this._profanities.Cast<string>().Where<string>((Func<string, bool>) (profanity => postAllowListSentence.ToLower(CultureInfo.InvariantCulture).Contains(profanity))));
    }
