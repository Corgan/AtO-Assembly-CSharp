...
// Type: PolygonArsenal.PolygonBeamScript
...
namespace PolygonArsenal
{
  public class PolygonBeamScript : MonoBehaviour
  {
    ...
    public void UpdateEndOffset() => this.beamEndOffset = this.endOffSetSlider.value;

    public void UpdateScrollSpeed() => this.textureScrollSpeed = this.scrollSpeedSlider.value;
