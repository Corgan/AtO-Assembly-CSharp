...
public class CardCraftItem : MonoBehaviour
{
  ...
  private void Awake()
  {
    this.singularityVector3Offset = Vector3.zero;
    this.singularityVector3Offset.x = 0.23f;
  }
  ...
  public void SetGenericCard(bool item = false)
  {
    ...
    else
    {
      ...
      if (!GameManager.Instance.IsSingularity())
        return;
      this.button.localPosition -= this.singularityVector3Offset;
    }
  }
  ...
  public void SetAvailability()
  {
    ...
    if (num1 >= num2 || CardCraftManager.Instance.HavePortraitItemBought(this))
    {
